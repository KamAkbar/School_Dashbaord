<template>
  <section class="container" style="overflow-x:auto;">
    ...
    <table class="table mt-5 table-responsive">
      <thead>
        <th scope="col">#</th>
        <th scope="col table__name">First Name</th>
        <th scope="col table__surname">Last Name</th>
        <th scope="col table__interesting">Interesting</th>
        <th scope="col table__class">Class</th>
        <th scope="col table__gender">Gender</th>
        <th scope="col table__data">Date of birth</th>
        <th scope="col table__activity">Activity</th>
      </thead>
      <tr v-for="(student, index) in students" :key="index">
        <th scope="col"> {{index + 1}} </th>
        <th scope="col table__name"> {{student.firstName}} </th>
        <th scope="col table__surname"> {{student.lastName}} </th>
        <th scope="col table__interesting"> {{student.interesting}} </th>
        <th scope="col table__class"> {{student.studentClass}} </th>
        <th scope="col table__gender"> {{student.gender}} </th>
        <th scope="col table__data"> {{student.dataOfBirth}} </th>
        <th class="table-btns table__activity" style="cursor: pointer"><svg @click="deleteButton(index)" class="delete" width="30" height="30" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path data-v-aeed2194="" d="M19.325 9.4682C19.325 9.4682 18.782 16.2032 18.467 19.0402C18.317 20.3952 17.48 21.1892 16.109 21.2142C13.5 21.2612 10.888 21.2642 8.28003 21.2092C6.96103 21.1822 6.13803 20.3782 5.99103 19.0472C5.67403 16.1852 5.13403 9.4682 5.13403 9.4682" stroke="#200E32" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path><path data-v-aeed2194="" d="M20.7082 6.23969H3.75024" stroke="#200E32" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path><path data-v-aeed2194="" d="M17.4406 6.23967C16.6556 6.23967 15.9796 5.68467 15.8256 4.91567L15.5826 3.69967C15.4326 3.13867 14.9246 2.75067 14.3456 2.75067H10.1126C9.53358 2.75067 9.02558 3.13867 8.87558 3.69967L8.63258 4.91567C8.47858 5.68467 7.80258 6.23967 7.01758 6.23967" stroke="#200E32" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path></svg>
